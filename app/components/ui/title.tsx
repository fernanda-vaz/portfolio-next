...
export default function SectionTitle({ children }: SectionTitleProps) {
  return (
    <div className='flex flex-col items-center w-full mb-8'>
      <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-mono mt-5 text-neonGreen-400 text-center flex flex-col gap-2'>
        {children}
        <svg
          xmlns='http://www.w3.org/2000/svg'
          viewBox='0 0 484 12'
          fill='none'
          className="stroke-neonGreen-400 text-center shadow-sm w-full" 
        >
          <path
